...
def detail(keyword):
    ...
    if not definitions:
        return render_template('error.html', msg=f'Could not find {keyword}')

    if type(definitions[0]) is str:
        print(definitions)
        return render_template('error.html', msg=f'Could not find {keyword}, did you mean,',definitions=definitions)
